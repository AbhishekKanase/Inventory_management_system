...
from util import mean_squared_error, root_mean_squared_error, max_error

# reading the train, test, answers
train = pd.read_csv("D:\\inventory management\\train_processed.csv")
test = pd.read_csv("D:\\inventory management\\test_processed.csv")
y_test = pd.read_csv("D:\\inventory management\\submission.csv")["Item_Outlet_Sales"]
...
outputDataFrame.to_csv("D:\\inventory management\\output_predicted.csv", index=False)